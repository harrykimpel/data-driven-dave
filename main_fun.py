...
def showTitleScreen(screen, tileset, ui_tiles):
    ...
    with tracer.start_as_current_span("showTitleScreen") as rollspan:
...
def showInterpic(completed_levels, screen, GamePlayer, tileset, ui_tileset):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("showInterpic") as rollspan:
        clock = pygame.time.Clock()
...
def showWarpZone(completed_levels, screen, GamePlayer, tileset, ui_tileset):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("showWarpZone") as rollspan:
        clock = pygame.time.Clock()
...
def getBonusMapping(current_level):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("getBonusMapping") as rollspan:
        if current_level == 2:
            return 6
...
def showScores(screen, tileset):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("showScores") as rollspan:
        pass


def savePlayerScore(player_score, screen, tileset):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("savePlayerScore") as rollspan:
        pass


def showCreditsScreen(screen, tileset):
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("showCreditsScreen") as rollspan:
        pass
...
def main():
    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("initGame") as rollspan:
        # Init pygame
        pygame.init()
        game_screen = Screen(SCREEN_WIDTH, SCREEN_HEIGHT)

    # This creates a new span that's the child of the current one
    with tracer.start_as_current_span("initTiles") as rollspan:
        # Init tiles
